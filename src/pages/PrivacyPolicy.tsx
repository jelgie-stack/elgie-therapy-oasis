...
const PrivacyPolicy = () => {
  return (
    <>
      <SEOHead 
        title="Privacy Policy | Brigette Elgie, LMFT"
        description="Privacy policy for Brigette Elgie, LMFT therapy services in Park City, UT."
        canonicalUrl="https://elgietherapy.com/privacy-policy"
      />
